...
export const heroSocialLinks: SocialLink[] = [
  ...
  { id: "tiktok", name: "btn_tiktok", href: "https://www.tiktok.com/@openick.io", iconType: "tiktok", gradient: "bg-gradient-to-r from-black to-gray-600  ", hoverColor: "hover:opacity-90" },
];
...
export const socialSectionLinks: SocialLink[] = [
  ...
  { id: "tiktok", name: "TikTok", href: "https://www.tiktok.com/@openick.io", iconType: "tiktok", gradient: "bg-gradient-to-r from-black to-gray-600   ", hoverColor: "hover:opacity-90", subtitle: "9785 Followers" },
