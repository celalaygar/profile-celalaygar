            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {contactChannels.map((channel, idx) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 rounded-xl border border-white/10 bg-gray-800/40 p-4 backdrop-blur-sm transition-all hover:border-violet-500/30 hover:bg-gray-800/70"
                >
                  <div className={`flex h-11 w-11 items-center justify-center rounded-lg ${channel.iconBg}`}>
